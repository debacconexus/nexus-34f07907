...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "RA Biologic Therapy Governance Hub";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "RA Patient Treatment Episode";
process.env.TABLE_NAME = process.env.TABLE_NAME || "ra_patient_treatment_episode_records";
'use strict';
